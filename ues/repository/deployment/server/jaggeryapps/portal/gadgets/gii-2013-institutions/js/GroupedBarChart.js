function GroupedBarChart(area, data, options) {
    ...
    this.draw = function() {
		...
		$("#grouped-bar-tooltip" + parseInt(groupedBarNum)).hide();
        ...
        barBundleGroup.selectAll("rect")
                .on("mouseover", function(d, i) {
                    ...
                    d3.select("#grouped-bar-tooltip-desc" + groupedBarNum).text(d.axis);
				...
				.on("click", function(d, i){
					fetchCustomData(d.id, d.axis.toString());
				});
